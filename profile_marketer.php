<?php
// ملف: profile_marketer.php - الملف الشخصي للمسوق
session_start();
include("config.php");
...
// التحقق من نوع المستخدم - يجب أن يكون مسوق
...
$user['user_type'] = $user['user_type'] ?? 'مسوق';
...
// حساب الإحصائيات للمسوق (من طلباته)
...
$available_balance = floatval($total_commissions) - floatval($withdrawn);
...
<head>
    ...
    <title>الملف الشخصي - المسوق</title>
...
<body class="bg-gray-50">
    <?php
    // Navbar مباشرة في الصفحة (نفس navbar المسوق)
    include("config.php");
    $user_id = $_SESSION['user_id'] ?? null;
    $user = null;
    if ($user_id && isset($conn)) {
    ...
    <nav class="main-navbar" id="mainNavbar">
        <div style="display: flex; align-items: center; gap: 2rem;">
            ...
            <div class="navbar-links">
                <a href="Home1.html" class="navbar-link">الرئيسية</a>
                <a href="product.html" class="navbar-link">المنتجات</a>
                <a href="orders.html" class="navbar-link">الطلبات</a>
                <a href="withdrawals.php" class="navbar-link">السحب</a>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-8 text-center">الملف الشخصي - المسوق</h1>
